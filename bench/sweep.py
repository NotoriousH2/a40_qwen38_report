...
CONFIGS=[
 dict(name="A_base",        model=Q3, ctx=131072, kv="q8_0", b=2048, ub=256,  spec=True,  nmax=4),
 dict(name="B_ub1024",      model=Q3, ctx=131072, kv="q8_0", b=2048, ub=1024, spec=True,  nmax=4),
 dict(name="C_ub2048",      model=Q3, ctx=131072, kv="q8_0", b=2048, ub=2048, spec=True,  nmax=4),
 dict(name="D_ub1024_n6",   model=Q3, ctx=131072, kv="q8_0", b=2048, ub=1024, spec=True,  nmax=6),
 dict(name="E_ub1024_n8",   model=Q3, ctx=131072, kv="q8_0", b=2048, ub=1024, spec=True,  nmax=8),
 dict(name="F_n8_f16kv",    model=Q3, ctx=131072, kv="f16",  b=2048, ub=1024, spec=True,  nmax=8),
 dict(name="G_nospec",      model=Q3, ctx=131072, kv="q8_0", b=2048, ub=1024, spec=False, nmax=0),
]

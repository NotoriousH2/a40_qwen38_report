...
CONFIGS=[
 dict(name="O_f16_n3", model=Q3, ctx=131072, kv="f16", b=2048, ub=256, spec=True, nmax=3),
 dict(name="P_f16_n5", model=Q3, ctx=131072, kv="f16", b=2048, ub=256, spec=True, nmax=5),
 dict(name="Q_f16_n6", model=Q3, ctx=131072, kv="f16", b=2048, ub=256, spec=True, nmax=6),
]
